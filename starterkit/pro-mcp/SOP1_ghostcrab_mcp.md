# SOP 1 — GhostCrab MCP (pro-mcp)

**Edition:** pro-mcp only. Voir [EDITIONS.md](../EDITIONS.md) pour changer de piste.

**Projections (prepare → audit):** [ROUTE_MAP § projections](ROUTE_MAP.md#route-projections) · mindCLI `mb_pragma` · [../scripts/README_projection_tools.md](../scripts/README_projection_tools.md)
