# SOP 2 — Préparation du matériel ontologique depuis un vault Obsidian vers GhostCrab MCP

**Version :** 1.0  
**Statut :** Draft exploitable  
**Périmètre :** De la structure brute d'un vault Obsidian à l'injection validée dans GhostCrab MCP / PostgreSQL
