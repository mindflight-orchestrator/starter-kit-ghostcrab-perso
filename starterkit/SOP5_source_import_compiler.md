# SOP 5 — Source import compiler generique vers GhostCrab / mindBrain

**Version :** 0.1  
**Statut :** Draft exploitable  
**Perimetre :** Transformer une source CSV/API/JSON/export applicatif en artefacts GhostCrab validables, sans specialiser le workflow a un projet donne.
